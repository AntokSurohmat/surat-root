                ...
                <div class="card card-outline card-primary">
                    ...
                    <form class="form-horizontal" role="form" id="form-addedit" autocomplete="off" onsubmit="return false" enctype="multipart/form-data">
                        ...
                        <div class="card-footer" style="text-align:center;">
                            <a type="button" href="<?= base_url('') ?>/Kepala/Rincian" class="btn btn-secondary mr-2"><i class="fas fa-arrow-left"></i>&ensp;Back</a>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Initialize select2
        var url_destination = '<?= base_url('Kepala/Rincian/getNoSpd') ?>';
        $("#noSpdForm").select2({
            theme: 'bootstrap4',
        ...
        $("#noSpdForm").change(function() { 
            var noSpd = $(this).val();
            var url_destination = '<?= base_url('Kepala/Rincian/getDetailNoSpd') ?>';
            $.ajax({
                    ...
                    if (data.success==true) {
                        ...
                        swalWithBootstrapButtons.fire({
                            ...
                            if (result.isConfirmed) {window.location.href = data.redirect;
                                ...
                                }else{window.location.replace("<?= base_url('Kepala/Rincian/new')?>");}
        ...
        function update() {
            if ($('#methodPage').val() === "Update" && $('#hiddenIDPage').val() != "") {
                var id = $('#hiddenIDPage').val();var url_destination = "<?= base_url('Kepala/Rincian/single_data') ?>";
                $.ajax({
