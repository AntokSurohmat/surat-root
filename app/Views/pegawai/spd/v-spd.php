...
<script type="text/javascript">
    $(function() {
        var url_destination = '<?= base_url('Pegawai/Spd/getNoSpdTable') ?>';
        $("#noSpdTable").select2({
            theme: 'bootstrap4',
        ...
        var url_destination = '<?= base_url('Pegawai/Spd/getInstansiTable') ?>';
        ...
        $(document).on('click', '.view', function() {
            var id = $(this).data('id');
            var url_destination = "<?= base_url('Pegawai/Spd/view_data') ?>";
            $.ajax({
                url: url_destination,
                type: "POST",
                data: {
