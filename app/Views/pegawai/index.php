        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= site_url() ?>">Pegawai</a></li>
        ...
        <div class="row">
            <div class="col-lg-6 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <a href="<?= site_url('pegawai/spt')?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-6 col-6">
                ...
                <div class="small-box bg-success">
                    ...
                    <a href="<?= site_url('pegawai/spd')?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
        </div>
