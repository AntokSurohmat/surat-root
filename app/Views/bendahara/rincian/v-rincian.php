...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var rinci = $('#rcn_data').DataTable({
            ...
            "columnDefs": [
                { targets: 0, orderable: false}, { targets: -1, orderable: false, "class": "text-center"},
            ],
        });
        ...
        $('#seachRcn').keyup(function() {rinci.search($(this).val()).draw();});
        $("#refresh").on('click', function() {document.getElementById("seachRcn").value = "";rinci.search("").draw();});
                        ...
                        success: function(data) {
                            ...
                            if (data.success) {
                                swalWithBootstrapButtons.fire({
                                    ...
                                    text: data.msg,showConfirmButton: true,timer: 4000
                                });$('#rcn_data').DataTable().ajax.reload(null, false);
                            } else {
                                swalWithBootstrapButtons.fire({
                                    icon: 'error',title: 'Not Deleted!',
                                    text: data.msg,showConfirmButton: true,timer: 4000
                                });$('#rcn_data').DataTable().ajax.reload(null, false);
                            }
                        },
