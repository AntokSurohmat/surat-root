            ...
            <div class="col-12">
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-11">
                            <p style="font-size:22px;text-align:center;line-height: 1.1em;font-weight:500;text-decoration: underline;" class="mb-0">SURAT PERINTAH TUGAS</p>
                            <p style="font-size:16px;text-align:center;line-height: 1em;font-weight:800;margin-bottom:8px;">no_spt</p>
                        </div>
                    </div><br><br><br><br>
                    <div class="row">
