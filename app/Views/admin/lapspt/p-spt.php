<!DOCTYPE html>
<html lang="en">
<!-- print and Download SPD one by One -->
<head>
	<meta charset="UTF-8">
			...
			<tr>
				...
				<td style="padding: 2px;">
					...
					foreach ($looping as $index => $pegawailooping) : ?>
						<?php foreach ($pegawailooping as $index => $datalooping) : ?>
		...
		<table border="0" width=100% style="margin-top: 5px;">
			...
			<tr>
				<td>
					...
					<p style="text-align:center;padding-top:3px;" class="mb-0">(<?= $pegawai['nip']?>)</p>
				</td>
			</tr>
		</table>
	</div>
