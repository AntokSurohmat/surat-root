...
<body>
	...
	<br>
	<table class="table table-borderless minimpadding" style="font-size: 16px; padding: 0 50px;">
		<tbody>
			<tr>
				...
				<td id="namaPegawaiModalViewTableLooping">
					...
					foreach ($looping as $index => $pegawailooping) : ?>
						<table class="table table-borderless nopadding">
							<tbody>
								<tr>
									<td style="width:5%;text-align:center;font-weight:600"><?= $m_angka[$index] ?>.</td>
									<td style="width:30%;font-weight:600">Nama</td>
									<td style="width:1%;font-weight:600">:</td>
									<td><?= $pegawailooping->nama?></td>
								</tr>
								<tr>
									<td></td>
									<td style="width:30%;font-weight:600">Pangkat Golongan</td>
									<td style="width: 1%;font-weight:600">:</td>
									<td><?= $pegawailooping->nama_pangol?></td>
								</tr>
								<tr>
									<td ></td>
									<td style="width:30%;font-weight:600">NIP</td>
									<td style="width: 1%;font-weight:600">:</td>
									<td><?= $pegawailooping->nip?></td>
								</tr>
								<tr>
									<td ></td>
									<td style="width:30%;font-weight:600">Jabatan</td>
									<td style="width: 1%;font-weight:600">:</td>
									<td><?= $pegawailooping->nama_jabatan?></td>
								</tr>
							</tbody>
						</table>
					<?php endforeach; ?>
