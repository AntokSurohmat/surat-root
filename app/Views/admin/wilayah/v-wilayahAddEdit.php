                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <span>
                                                <button type="button" class="btn btn-outline-warning" data-rel="tooltip" data-placement="top" title="Tambah Zonasi" id="add-zona"> <i class="fa fa-plus" aria-hidden="true"></i> </button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" role="form" id="form-prov" autocomplete="off" onsubmit="return false">
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="provinsiModalProv" class="col-sm-3 col-form-label">Provinsi</label>
                                <div class="col-sm-9">
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" role="form" id="form-kab" autocomplete="off" onsubmit="return false">
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="kabupatenModalKab" class="col-sm-3 col-form-label">Kota/Kab.</label>
                                <div class="col-sm-9">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="invalid-feedback kabupatenErrorModal"></div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="kecamatanModalKec" class="col-sm-3 col-form-label">Kec.</label>
                                <div class="col-sm-9">
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" role="form" id="form-zona" autocomplete="off" onsubmit="return false">
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="jenisWilayahModalZona" class="col-sm-3 col-form-label">Jenis Wilayah</label>
                                <div class="col-sm-9">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#modal-kab').on('shown.bs.modal', function() {
            $('#provinsiModalKab').select2('open');$('#provinsiModalKab').on('select2:select', function(e) {$('#kabupatenModalKab').focus();});
        ...
        $('#modal-kec').on('hidden.bs.modal', function() {
            $(this).find('form')[0].reset();
            $("#provinsiModalKec").empty();$("#provinsiModalKec").removeClass('is-valid');$("#provinsiModalKec").removeClass('is-invalid');
        ...
        $('#modal-kec').on('shown.bs.modal', function() {
            $('#provinsiModalKec').select2('open');$('#provinsiModalKec').on('select2:select', function(e) {$('#kabupatenModalKec').select2('open');});
        ...
        $('#modal-jenis').on('shown.bs.modal', function() {
            $('#jenisWilayahModalJenis').focus();$('#jenisWilayahModalJenis').keydown(function(event) {if (event.keyCode == 13) {$('#submit-btn-jenis').focus();}});
        });
            ...
            if ($('#methodPage').val() === "Update" && $('#hiddenIDPage').val() != "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#provinsiForm").append($("<option selected='selected'></option>").val(data.provinsi.id).text(data.provinsi.nama_provinsi)).trigger('change');
                        $("#kabupatenForm").append($("<option selected='selected'></option>").val(data.kabupaten.id).text(data.kabupaten.nama_kabupaten)).trigger('change');
                        $("#kecamatanForm").append($("<option selected='selected'></option>").val(data.kecamatan.id).text(data.kecamatan.nama_kecamatan)).trigger('change');
                        $("#jenisWilayahForm").append($("<option selected='selected'></option>").val(data.jenis.id).text(data.jenis.jenis_wilayah)).trigger('change');
                        $("#zonasiForm").append($("<option selected='selected'></option>").val(data.zonasi.id).text(data.zonasi.nama_zonasi)).trigger('change');
